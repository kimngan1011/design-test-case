...
**Read and follow the full instructions in `.claude/agents/analyze-requirement.agent.md`.**

This master agent runs 7 internal phases (fetch → domain knowledge → search → lesson-learned → impact analysis → questions → cleanup). It includes a Micro-Approval Gate after its Phase 1 and a 13-point Active Validation Loop before presenting questions.
...
**Read and follow the full instructions in `.claude/skills/define-test-coverage/SKILL.md`.**
...
**Read and follow the full instructions in `.claude/skills/generate-test-cases/SKILL.md`.**
...
**Read and follow the full instructions in `.claude/skills/import-to-qase/SKILL.md`.**
...
- [ ] Spec file exists at `input/specs/<TICKET-ID>: <Feature Name>/spec.md`
...
- [ ] E2E Scenario Impact section populated
- [ ] 13-point validation loop passed (report printed)
