...
> **Theme:** Import class members, assign multiple classes to a lesson via Lesson Schedule Class, then verify publish → BO → Mobile lifecycle.
> **Updated:** 2026-05-18 (LT-74136 — Step 4 data path updated to LSC; dedup step added)
...
| 4   | [SF]     | Staff assigns **Class 1 + Class 2** to a lesson by adding two **Lesson Schedule Class** records (one per class) via the LSC related list                                                 |
| 5   | [System] | Students from both classes auto-assigned via Master Queue; **dedup guardrail** (LT-99546 unique key on student_id+lesson_id) prevents duplicate sessions for any student in both classes |
| 6   | [SF]     | Staff **assigns a teacher** to the lesson                                                                                                                                                |
| 7   | [SF]     | Staff **publishes** the lesson                                                                                                                                                           |
| 8   | [BO]     | Teacher views the lesson with auto-assigned students on **BO Calendar**; lesson card shows both classes                                                                                  |
| 9   | [Mobile] | Student A views the lesson on **Learner App** schedule; lesson detail shows both classes                                                                                                 |
