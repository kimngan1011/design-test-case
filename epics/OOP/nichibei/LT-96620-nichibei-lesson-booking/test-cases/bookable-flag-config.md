...
### [Nichibei] Lesson Booking – Bookable Flag – Turned ON – Lesson appears in Lesson Lists

**Description:** AC 06.1 — BR-5: State Transition: After turning Bookable Flag ON for a lesson, it becomes visible in the student's Lesson Lists (assuming all other visibility conditions are met).

**Preconditions:**
A lesson at student's LA location (Published, date = 2026-05-26) has Bookable_Flag=FALSE. Student cannot see it in Lesson Lists.

| #   | Action                                                              | Expected Result                       | Test Data |
| --- | ------------------------------------------------------------------- | ------------------------------------- | --------- |
| 1   | Confirm lesson is NOT visible in Lesson Lists (Bookable_Flag=FALSE) | Lesson not shown in Lesson Lists      | —         |
| 2   | Staff turns Bookable Flag ON for the lesson in Salesforce           | Flag updated to TRUE                  | —         |
| 3   | Student refreshes Lesson Lists                                      | Lesson is now visible in Lesson Lists | —         |
...
| 4   | Verify My Lessons for affected students                       | Both students still see the lesson in their My Lessons | —         |

---

### [Nichibei] Lesson Booking – Bookable Flag – Turned OFF – Lesson no longer shown in Lesson Lists

**Description:** AC 06.1 — BR-5: State Transition: After turning Bookable Flag OFF, the lesson must NOT appear in Lesson Lists.

**Preconditions:**
A lesson at student's LA location (Published, date = 2026-05-26) has Bookable_Flag=TRUE and is visible in Lesson Lists.

| #   | Action                                                         | Expected Result                             | Test Data |
| --- | -------------------------------------------------------------- | ------------------------------------------- | --------- |
| 1   | Confirm lesson IS visible in Lesson Lists (Bookable_Flag=TRUE) | Lesson shown in Lesson Lists                | —         |
| 2   | Staff turns Bookable Flag OFF in Salesforce                    | Flag updated to FALSE                       | —         |
| 3   | Student refreshes Lesson Lists                                 | Lesson is no longer visible in Lesson Lists | —         |
...
### [Nichibei] Lesson Booking – Access Control – Feature disabled – Reservation List menu hidden

**Description:** PRD/Config — BR-28: Decision Table: When the Lesson Booking feature is disabled for the partner, the Reservation List menu must NOT appear in the student's app navigation.
...
| 2   | View app navigation / main menu                                 | "Reservation List" menu entry is NOT visible | —                       |

---

### [Nichibei] Lesson Booking – Access Control – Feature enabled – Reservation List menu visible

**Description:** PRD/Config — BR-28: Decision Table: When the Lesson Booking feature is enabled for the partner, the Reservation List menu must appear in the student's app navigation.
...
| 2   | View app navigation / main menu                                | "Reservation List" menu entry IS visible | —                      |

---

### [Nichibei] Lesson Booking – Access Control – Parent user – Reservation List menu not accessible
...
| 2   | View app navigation / main menu                               | "Reservation List" menu entry is NOT visible for parent | —              |
| 3   | Login to app as the linked student user                       | App home screen shown                                   | Role = Student |
| 4   | View app navigation / main menu                               | "Reservation List" menu entry IS visible for student    | —              |
