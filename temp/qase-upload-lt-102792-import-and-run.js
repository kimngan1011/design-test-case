...
const suiteId = 2612;
const csvPath =
  "epics/event/LT-102792-target-segment-duplicate-prevention/test-cases/target-segment-duplicate-prevention.csv";
const summaryPath = "temp/qase-upload-lt-102792-summary.json";
const existingCaseIds = [
  19038, 19039, 19042, 19043, 19067, 19068, 19069, 19070, 19071, 19072, 21530, 21555,
];
...
async function main() {
  ...
  const run = await qase("POST", `/run/${project}`, {
    title: "LT-102792 - Target Segment Duplicate Prevention",
    description:
      "Manual QA run for LT-102792. Includes newly-created duplicate-prevention cases plus existing Target Segment lookup, add-flow, eligibility, enrollment-status, and duplicate-location regression cases.",
